...
let
  ...
  cfg = config.${namespace}.desktop.gnome.extensions;
in
{
  options.${namespace}.desktop.gnome.extensions = {
    enable = mkBoolOpt false "Enable GNOME Extensions";
  };
